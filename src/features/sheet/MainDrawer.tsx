            ...
            return (
                <View style={styles.container}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.eyebrow} accessibilityLabel="Mobile v2">Mobile v2</Text>
                        <Text style={styles.title} accessibilityLabel={content.title}>{content.title}</Text>
                        <Text style={styles.detail} accessibilityLabel={content.detail}>{content.detail}</Text>
                    </View>
...
function BackButton({ onPress }: { onPress: () => void }) {
    return (
        ...
        >
            <Text style={styles.backText} accessibilityLabel="Back">Back</Text>
        </Pressable>
    );
}
    ...
    return (
        ...
        >
            <View style={styles.actionCopy}>
                <Text style={styles.actionTitle} accessibilityLabel={title}>{title}</Text>
                <Text style={styles.actionDescription} accessibilityLabel={description}>{description}</Text>
            </View>
