...
export function SettingsScreen({ onNavigate }: SettingsScreenProps) {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.eyebrow} accessibilityLabel="Settings">Settings</Text>
            <View style={styles.titleRow}>
                <Text style={styles.title} accessibilityLabel="Game Settings">Game Settings</Text>
                <Pressable
                ...
                >
                    <Text style={styles.shareButtonText} accessibilityLabel="Share">Share</Text>
                </Pressable>
            </View>
            <Text style={styles.detail} accessibilityLabel="Adjust the map area and app preferences.">
