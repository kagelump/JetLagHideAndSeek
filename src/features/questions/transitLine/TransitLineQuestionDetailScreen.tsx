...
export function TransitLineQuestionDetailScreen({
    ...
    const routeNames = new Map(selectedRoutes.map((route) => [route.id, route.name]));
    ...
    return (
        <>
            ...
            <Text style={styles.detail}>Are you on the selected transit line?</Text>
                ...
                {lineOptions.map((line) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Text style={styles.meta}>{line.stationCount} stations</Text>
                        </Pressable>
                    );
                })}
            </View>
...
const styles = StyleSheet.create({
    ...
    eyebrow: { color: colors.tint, fontSize: 12, fontWeight: "800", textTransform: "uppercase" },
    lineName: { color: colors.ink, fontSize: 16, fontWeight: "700" },
    lineRow: { borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 12, backgroundColor: colors.card },
    lineRowSelected: { borderColor: colors.tint, backgroundColor: colors.buttonSubtle },
