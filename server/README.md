...
| `CAS_MAX_BLOB_BYTES` | `20971520` | Max canonical (UTF-8) payload size after decompress |
...
- `PUT /api/cas/blobs/overpass/:sid` — Overpass namespaced blob write.
- `GET /api/cas/blobs/overpass/:sid` — Overpass namespaced blob read.
- `DELETE /api/cas/index/overpass/:requestHash` — invalidate request-hash mapping.
